/*
  ...
  2. Enhanced Existing Tables
    ...
    - Add match score to matches
    - Add message type to messages
    - Add difficulty level and estimated hours to study plans
    - Add recording URL to sessions
    - Add tags to reviews
...
-- Insert enhanced sample subjects (using DO block to handle conflicts)
DO $$
BEGIN
...
-- Insert sample achievements (using DO block to handle conflicts)
DO $$
BEGIN
...
EXCEPTION
  WHEN unique_violation THEN
    -- Handle case where profile or preferences already exist
    RETURN new;
END;
